...
EXCLUDED_DOCS=(
  ...
  "abi_layout.md	generated evidence document (machine-generated from abi_schema.toml — no hand-written grammar examples)"
  "stabilized_layout_tables.md	generated evidence document (machine-generated from abi_schema.toml [layout.frozen] — no hand-written grammar examples)"
  "test_requirements.md	generated evidence document (machine-generated from the five schemas — no hand-written grammar examples)"
