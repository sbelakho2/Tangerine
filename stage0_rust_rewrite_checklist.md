...
- [ ] Strict end-to-end validation is not green yet. Evidence: `cargo run -- codegen-scan ../golden` currently reports `supported=18 unsupported=12`, and `cargo run -- codegen-scan ../tg_compiler` currently reports `supported=0 unsupported=34` on 2026-03-11.
